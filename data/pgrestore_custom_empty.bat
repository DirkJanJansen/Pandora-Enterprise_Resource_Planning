...
echo Only functional data is present in this database
...
"C:\programdata\postgres\bin\pg_restore.exe" --dbname=bisystem  --verbose C:\programdata\postgres\backup\bisystem.empty.backup
