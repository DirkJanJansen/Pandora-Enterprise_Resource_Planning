...
def updateOK():
    ...
    msg.setText('Your details have been adjusted!')
...
def calcBestaat():
    ...
    msg.setStyleSheet("color: black;  background-color: gainsboro")
    msg.setIcon(QMessageBox.Information)
    msg.setText('Calculation rule already exists\nen is settled with\ninintroduced quantity!')
    msg.setFont(QFont("Arial",10))
    msg.setWindowTitle('Insert clusters')
    msg.exec_()   
        ...
        if idx.column() == 0:
            ...
            class MainWindow(QDialog):
                def __init__(self):
                    ...
                    grid.addWidget(QLabel('Modify cluster'), 0, 1, 1, 8, Qt.AlignCenter)
                    ...
                    grid.addWidget(cancelBtn, 16, 5, 1, 2, Qt.AlignRight)
                    cancelBtn.setFont(QFont("Arial",10))
