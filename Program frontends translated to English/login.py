...
def hoofdMenu(m_email):
    ...
    class Widget(QDialog):
        def __init__(self, parent=None):
            ...
            k8Edit.addItem('4. Insert item lines per cluster')
            k8Edit.addItem('5. Request item lines per cluster') 
            k8Edit.addItem('6. Create / change calculation')
            k8Edit.addItem('7. Calculation / Item list - \n    calculate / request / printing')
            ...
            k9Edit.addItem('4. Insert item lines per cluster')
            k9Edit.addItem('5. Request item lines per cluster')
            k9Edit.addItem('6. Create / change calculation')
            k9Edit.addItem('7. Calculation / Item list - \n    calculate / request / printing')
