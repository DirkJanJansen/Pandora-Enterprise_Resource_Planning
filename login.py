...
def hoofdMenu(m_email):
    ...
    class Widget(QDialog):
        def __init__(self, parent=None):
            ...
            self.k11Edit.addItem('9. Request Equipment hours mutations')
            ...
            lineperm = ([0, 4, 6, 2, 2, 5],[0, 3, 4, 6, 1],[0, 1, 4, 6, 6],[0, 3, 4, 3, 7, 6, 6, 6 ],[0, 3, 4, 6, 1, 6],\
                        ...
                        [0, 3, 4, 6, 3, 6, 3, 6, 1, 1],[0, 4, 4, 6, 3, 6, 3, 6, 1, 1],[0, 6, 2, 1, 6, 3, 4, 1, 7, 7, 7],\
                        [0, 6, 6, 2, 6, 2, 5, 6, 7, 6],[0, 2, 1, 1, 1],[0, 1, 6, 6, 6, 7],[0, 1, 3, 3, 7, 4],[0])
